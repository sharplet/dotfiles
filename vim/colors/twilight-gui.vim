...
let colors_name = "twilight-gui"

let s:grey_blue = '#889ab4'
...
let s:red = '#d08356'
let s:cyan = '#74dad9'
let s:darkgrey = '#181818'
let s:grey = '#303030'
let s:mid_grey = '#5f5a60'
let s:lightgrey = '#605958'
let s:white = '#f8f8f8'
let s:grey_brown = '#757168'
...
exe 'hi NonText        guifg='.s:grey_brown        .' guibg='.s:darkgrey
...
exe 'hi FoldColumn     guifg='.s:darkgrey          .' guibg='.s:darkgrey        .' gui=none'
exe 'hi SignColumn     guifg='.s:grey_blue         .' guibg='.s:dark_grey_blue  .' gui=none'

exe 'hi Comment        guifg='.s:mid_grey          .' guibg='.s:darkgrey        .' gui=italic'
